...
<body>
	...
	资讯列表 <a class="btn btn-success radius r mr-20"
	...
	<div class="pd-20">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				...
				onclick="news_add('添加资讯','news-add.jsp')" href="javascript:;"> <i
					class="Hui-iconfont">&#xe600;</i> 添加资讯
			...
			<table
				...
				<tbody>
					...
					<s:iterator value="#request.news">
						<s:if test="#request.newsStatus==1">
							<tr class="text-c">
								<td><input type="checkbox" value="${id}" name="newsid"></td>
								<td>${id }</td>
								<td class="text-l"><u style="cursor: pointer"
									class="text-primary"
									onClick="article_edit('查看','news-edit?id=${id}',$(this).attr('id'))"
									title="查看">${newsTittle}</u></td>
								<td>行业动态</td>
								<td>${newsAuthor}</td>
								<td>${newsDate}</td>
								<td>21212</td>
								...
								<td class="f-14 td-manage"><a id=${id
									}
									style="text-decoration: none"
									onClick="article_stop(this,$(this).attr('id'))"
									href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i>
								</a> <a style="text-decoration: none" class="ml-5"
									onClick="article_edit('资讯编辑','news-edit?id=${id}',$(this).attr('id'))"
									href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
									<a id=${id } style="text-decoration: none" class="ml-5"
									onClick="news_del(this,$(this).attr('id'))" href="javascript:;"
									title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
						</s:if>
						<s:elseif test="#request.newsStatus==0">
							<tr class="text-c">
								<td><input type="checkbox" value="${id}" name="newsid"></td>
								<td>${id }</td>
								<td class="text-l"><u style="cursor: pointer"
								...
								<td class="td-status"><span
									class="label
									label-success radius">草稿</span></td>
								<td class="f-14 td-manage"><a id=${id
								}
									onClick="article_start(this,$(this).attr('id'))"
									href="javascript:;" title="发布"><i class="Hui-iconfont">&#xe603;</i>
								</a> <a id=${id
								} style="text-decoration: none"
									class="ml-5"
									onClick="article_edit('资讯编辑','news-edit?id=${id}',$(this).attr('id'))"
									...
									class="ml-5" onClick="news_del(this,$(this).attr('id'))"
	...
	<script type="text/javascript">
		...
		function datadel() {
			...
			var checked_num = $("input[name='newsid']:checked").length;
			if (checked_num == 0) {
				alert("至少选择一项");
				return;
			}
			var idList = [];
			var check_obj = $("input[name='newsid']");

			for (var i = 0; i < check_obj.length; i++) {
				if (check_obj.get(i).checked == true) {
					//alert(check_obj.get(i).value);
					idList.push(check_obj[i].value);
					...
					.confirm(
							...
							function(index) {
								...
								$(obj)
										...
										.find(".td-manage")
										.prepend(
												'<a id=${id}  onClick="article_start(this,$(this).attr("id"))"href="javascript:;" title="发布"><i class="Hui-iconfont">&#xe603;</i></a>');
								$(obj)
										.parents("tr")
										.find(".td-status")
										.html(
					...
					.confirm(
							...
							function(index) {
								...
								$(obj)
										...
										.find(".td-manage")
										.prepend(
												'<a id=${id}  onClick="article_stop(this,$(this).attr("id"))"href="javascript:;" title="发布"><i class="Hui-iconfont">&#xe603;</i></a>');
								$(obj)
										.parents("tr")
										.find(".td-status")
										.html(
		...
		function article_shenqing(obj, id) {
			$(obj).parents("tr").find(".td-status").jsp(
