		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				...
				onclick="picture_add('添加图片','picture-add.jsp')" href="javascript:;"><i
					class="Hui-iconfont">&#xe600;</i> 添加图片</a></span> <span class="r">共有数据：<strong>54</strong>
				条
			</span>
		</div>
		<div class="mt-20">
				...
				<tbody>
					<tr class="text-c">
						...
						<td><a href="javascript:;"
							onClick="picture_edit('图库编辑','picture-show.jsp','10001')"><img
								width="100" class="picture-thumb" src="pic/200x150.jpg"></a></td>
						<td class="text-l"><a class="maincolor" href="javascript:;"
							onClick="picture_edit('图库编辑','picture-show.jsp','10001')">现代简约
								白色 餐厅</a></td>
