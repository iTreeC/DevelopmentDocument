 ...
 */
@Entity
@Table(name="t_news",catalog="itree")
public class TNews implements java.io.Serializable {
	...
	public String toString() {
		return "TNews [id=" + id + ", TPhoto=" + TPhoto + ", newsTittle=" + newsTittle + ", newsContent=" + newsContent
				+ ", newsProfile=" + newsProfile + ", newsAuthor=" + newsAuthor + ", newsDate=" + newsDate
