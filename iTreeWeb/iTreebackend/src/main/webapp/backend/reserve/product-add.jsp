...
<body>
	<div class="pd-20">
		<form action="" method="post" class="form form-horizontal"
			id="form-article-add">
			<div class="row cl">
				<label class="form-label col-2"><span class="c-red">*</span>äº§åæ é¢ï¼</label>
			...
			<div class="row cl">
				<label class="form-label col-2">ç®ç¥æ é¢ï¼</label>
				<div class="formControls col-10">
					<input type="text" class="input-text" value="" placeholder="" id=""
						name="">
				</div>
			...
			<div class="row cl">
				<label class="form-label col-2"><span class="c-red">*</span>åç±»æ ç®ï¼</label>
				<div class="formControls col-2">
					<span class="select-box"> <select name="" class="select">
							<option value="0">ä¸çº§åç±»</option>
							<option value="1">ä¸çº§åç±»</option>
							<option value="11">âäºçº§åç±»</option>
							<option value="12">âäºçº§åç±»</option>
							<option value="13">âäºçº§åç±»</option>
					</select>
					</span>
				</div>
				<label class="form-label col-2">æåºå¼ï¼</label>
				<div class="formControls col-2">
					<input type="text" class="input-text" value="0" placeholder=""
						id="" name="">
				</div>
				<label class="form-label col-2">åè®¸è¯è®ºï¼</label>
			...
			<div class="row cl">
				<label class="form-label col-2">äº§åè§æ ¼ï¼</label>
				<div class="formControls col-10">
					<input type="text" name="" id="" placeholder="è¾å¥é¿åº¦"
						value="" class="input-text" style="width: 25%"> MM <input
						type="text" name="" id="" placeholder="è¾å¥å®½åº¦" value=""
						class="input-text" style="width: 25%"> MM <input
						type="text" name="" id="" placeholder="è¾å¥é«åº¦" value=""
						class="input-text" style="width: 25%"> MM
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-2">äº§å°ï¼</label>
				<div class="formControls col-10">
			...
			<div class="row cl">
				<label class="form-label col-2">æè´¨ï¼</label>
				<div class="formControls col-4">
					<input type="text" name="" id="" placeholder="" value=""
						class="input-text">
				</div>
				<label class="form-label col-2">æå±ä¾åºåï¼</label>
				<div class="formControls col-4">
					<input type="text" name="" id="" placeholder="" value=""
						class="input-text">
				</div>
			...
			<div class="row cl">
				<label class="form-label col-2">ä»·æ ¼è®¡ç®åä½ï¼</label>
				<div class="formControls col-4">
				...
				<label class="form-label col-2">äº§åééï¼</label>
				<div class="formControls col-4">
					<input type="text" name="" id="" placeholder="" value=""
						class="input-text" style="width: 90%"> kg
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-2">äº§åå±ç¤ºä»·æ ¼ï¼</label>
				<div class="formControls col-4">
					<input type="text" name="" id="" placeholder="" value=""
						class="input-text" style="width: 90%"> å
				</div>
				<label class="form-label col-2">å¸åºä»·æ ¼ï¼</label>
				<div class="formControls col-4">
					<input type="text" name="" id="" placeholder="" value=""
						class="input-text" style="width: 90%"> å
				</div>
			...
			<div class="row cl">
				<label class="form-label col-2">ææ¬ä»·æ ¼ï¼</label>
				<div class="formControls col-4">
					<input type="text" name="" id="" placeholder="" value=""
						class="input-text" style="width: 90%"> å
				</div>
				<label class="form-label col-2">æä½éå®ä»·æ ¼ï¼</label>
				<div class="formControls col-4">
					<input type="text" name="" id="" placeholder="" value=""
						class="input-text" style="width: 90%"> å
				</div>
			...
			<div class="row cl">
				<label class="form-label col-2">éå®å¼å§æ¶é´ï¼</label>
				<div class="formControls col-4">
					<input type="text"
				...
				<label class="form-label col-2">éå®ç»ææ¶é´ï¼</label>
				<div class="formControls col-4">
					<input type="text"
			...
			<div class="row cl">
				<label class="form-label col-2">äº§åå³é®å­ï¼</label>
				<div class="formControls col-10">
					<input type="text" name="" id=""
						placeholder="å¤ä¸ªå³é®å­ç¨è±æéå·éå¼ï¼é10ä¸ªå³é®å­"
						value="" class="input-text">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-2">äº§åæè¦ï¼</label>
				<div class="formControls col-10">
					<textarea name="" cols="" rows="" class="textarea"
						placeholder="è¯´ç¹ä»ä¹...æå°è¾å¥10ä¸ªå­ç¬¦"
						datatype="*10-100" dragonfly="true"
						nullmsg="å¤æ³¨ä¸è½ä¸ºç©ºï¼" onKeyUp="textarealength(this,200)"></textarea>
			...
			<div class="row cl">
				<label class="form-label col-2">ç¼©ç¥å¾ï¼</label>
				<div class="formControls col-10">
					<div class="uploader-thum-container">
						<div id="fileList" class="uploader-list"></div>
						<div id="filePicker">éæ©å¾ç</div>
						<button id="btn-star"
							class="btn btn-default btn-uploadstar radius ml-10">å¼å§ä¸ä¼ </button>
					</div>
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-2">å¾çä¸ä¼ ï¼</label>
				<div class="formControls col-10">
			...
			<div class="row cl">
				<label class="form-label col-2">è¯¦ç»åå®¹ï¼</label>
				<div class="formControls col-10">
			...
			<div class="row cl">
				<div class="col-10 col-offset-2">
					<button onClick="article_save_submit();"
						...
						<i class="Hui-iconfont">&#xe632;</i> ä¿å­å¹¶æäº¤å®¡æ ¸
					</button>
					<button onClick="article_save();" class="btn btn-secondary radius"
						type="button">
						<i class="Hui-iconfont">&#xe632;</i> ä¿å­èç¨¿
					</button>
					<button onClick="layer_close();" class="btn btn-default radius"
						type="button">&nbsp;&nbsp;åæ¶&nbsp;&nbsp;</button>
				</div>
			</div>
		</form>
	</div>
