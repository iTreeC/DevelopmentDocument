...
<body>
	<header class="Hui-header cl"> <a class="Hui-logo l"
		title="H-ui.admin v2.3" href="/">iTree.admin</a> <a
		class="Hui-logo-m l" href="/" title="H-ui.admin">iTree</a> <span
		class="Hui-subtitle l">V1.0</span> <nav class="mainnav cl"
		id="Hui-nav">
	<ul>
 ...
 -->
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a _href="news-list" href="javascript:void(0)">资讯管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a _href="#" href="javascript:;">评论列表</a></li>
		...
		<!-- <dl id="menu-member">
			...
			<dd>
				<ul>
					...
					<li><a _href="member-level.jsp" href="javascript:;">等级管理</a></li>
					<li><a _href="member-scoreoperation.jsp" href="javascript:;">积分管理</a></li>
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					...
					<li><a _href="userAction!userList.action" href="javascript:void(0)">管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		<!-- <dl id="menu-tongji">
			...
			<dd>
				<ul>
					<li><a _href="charts-1.jsp" href="javascript:void(0)">折线图</a></li>
					<li><a _href="charts-2.jsp" href="javascript:void(0)">时间轴折线图</a></li>
					<li><a _href="charts-3.jsp" href="javascript:void(0)">区域图</a></li>
					<li><a _href="charts-4.jsp" href="javascript:void(0)">柱状图</a></li>
					<li><a _href="charts-5.jsp" href="javascript:void(0)">饼状图</a></li>
					<li><a _href="charts-6.jsp" href="javascript:void(0)">3D柱状图</a></li>
					<li><a _href="charts-7.jsp" href="javascript:void(0)">3D饼状图</a></li>
				</ul>
			</dd>
		</dl> -->
		<dl id="menu-system">
