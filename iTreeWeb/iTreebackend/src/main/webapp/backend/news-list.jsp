		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
					批量删除</a>
					 <a class="btn btn-primary radius" onclick="news_add('添加资讯','news-add.jsp')" href="javascript:;">
					 <i class="Hui-iconfont">&#xe600;</i> 添加资讯</a></span> <span class="r">共有数据：<strong>54</strong>
				条
			</span>
		</div>
		<div class="mt-20">
				...
				<s:iterator value="#request.news">
					<tr class="text-c">
						...
						<td class="text-l"><u style="cursor: pointer"
							class="text-primary"
							onClick="article_edit('查看','article-zhang.jsp','10001')"
						...
						<td class="f-14 td-manage"><a style="text-decoration: none"
							...
							onClick="article_edit('资讯编辑','article-add.jsp','10001')"
