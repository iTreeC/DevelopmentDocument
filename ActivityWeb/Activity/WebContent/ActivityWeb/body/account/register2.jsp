...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	%>
	<!-- 马大洲--将输入框中的信息保存在session中 -->
	<%
		//手机号输入框
		String telphoned=request.getParameter("telphone-register");
		if(request.getParameter("telphone-register")==null){
			telphoned="";
		}
		//登录密码输入框
		String passwd1ed=request.getParameter("passwd1");
		if(request.getParameter("passwd1")==null){
			passwd1ed="";
		}
		//确认密码输入框
		String passwd_registered=request.getParameter("passwd-register");
		if(request.getParameter("passwd-register")==null){
			passwd_registered="";
		}
	%>
...
<html lang="zh-CN">
  <head>
	...
	<link rel="icon" href="/Activity/ActivityWeb/favicon.ico">
    
    <title>注册界面</title>
    <!-- Bootstrap -->
     <link href="/Activity/ActivityWeb/css/bootstrap.css" rel="stylesheet">
    <link href="/Activity/ActivityWeb/css/main.css" rel="stylesheet" type="text/css">
    <link href="/Activity/ActivityWeb/css/account.css" rel="stylesheet" type="text/css">
...
a:hover{
  ...
  <nav class="navbar navbar-default">
          ...
          <a class="navbar-brand" href="#">
            <img alt="logo" src="/Activity/ActivityWeb/images/logo.jpg">
          </a>
  </nav>
  </div>
    <!--品牌end-->
   ...
   <div class="body">
    <div class="container">
 	 <div class="row account">           
            <div class="col-sm-8">    
                <img src="/Activity/ActivityWeb/images/banner2.png">
...
<form class="form-horizontal" action="/Activity/addUser.action" method="post">
 ...
 <font color="red"><div id="error">${adderror}</div></font>
 <table width="300" border="0" cellpadding="15px" class="hang" >
  <tr>
    <td width="100">手机号码:</td>
    <td height="25" colspan="2"><input type="text" class="form-control" placeholder="请输入手机号码" aria-describedby="sizing-addon1" id="telphone-register" name="telphone-register" onblur="yz()" value="<%=telphoned%>"></td>
  </tr>
  <tr>
    <td>图片验证码:</td>
  ...
  <tr>
    <td>登录密码:</td>
    <td colspan="2"><input type="password" class="form-control" placeholder="请输入登录密码" aria-describedby="sizing-addon1" id="passwd1" name="passwd1" value="<%=passwd1ed%>"></td>
  </tr>
  <tr>
    <td>确认密码:</td>
    <td colspan="2"><input type="password" class="form-control" placeholder="请输入确认密码" aria-describedby="sizing-addon1" id="passwd-register" name="passwd-register" value="<%=passwd_registered%>"></td>
  </tr>
</table>
...
<div  style="width:300px;text-align: center;">
 	 <span class="rg_row" style=" text-align: center; font-family: Tahoma, Geneva, sans-serif; font-size: 12px"><span>已有账号?</span>  <a class="regist_btn" style="padding-left:45px;" href="/Activity/ActivityWeb/body/account/login2.jsp">立即登录</a></span></div>
	</div>
</div>
    ...
    <div class="container">
        <div class="row">           
            <div class="col-sm-4">    
                <img src="/Activity/ActivityWeb/images/footer.jpg">
        ...
        <ul>
          ...
          <li>
            ...
            <div class="col-sm-1">    
                <img src="/Activity/ActivityWeb/images/weixin.jpg">
                 <p>扫码关注微信平台</p>       
            </div>
    ...
    <!-- 和上面一起的 -->
    <script src="/Activity/ActivityWeb/js/bootstrap.min.js"></script>
  </body>
</html>