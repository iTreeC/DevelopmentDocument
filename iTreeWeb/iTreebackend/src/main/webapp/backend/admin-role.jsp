...
<body>
	...
	<div class="pd-20">
		<div class="cl pd-5 bg-1 bk-gray">
			...
			<s:set id="d" value="d"></s:set>
			<span class="r">共有数据：<strong>${d.size()}</strong> 条
			</span>
		</div>
				...
				<s:iterator id="d" value="d">
					<tr class="text-c">
						...
						<td class="f-14"><a title="编辑" href="javascript:;"
							onclick="admin_role_edit('角色编辑','admin-role-add.jsp','1')"
							style="text-decoration: none"><i class="Hui-iconfont">&#xe6df;</i></a>
							<a title="删除" href="javascript:;" id="${id}"
							onclick="admin_role_del(this,$(this).attr('id'))" class="ml-5"
