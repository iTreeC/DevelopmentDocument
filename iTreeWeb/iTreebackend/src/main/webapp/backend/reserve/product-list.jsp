		...
		<div class="pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l"><a href="javascript:;" onclick="datadel()"
					...
					onclick="product_add('添加产品','product-add.jsp')" href="javascript:;"><i
						class="Hui-iconfont">&#xe600;</i> 添加产品</a></span> <span class="r">共有数据：<strong>54</strong>
					条
				</span>
			</div>
			<div class="mt-20">
				<table
					...
					<tbody>
						<tr class="text-c va-m">
							...
							<td>001</td>
							<td><a
								onClick="product_show('哥本哈根橡木地板','product-show.jsp','10001')"
							...
							<td class="text-l"><a style="text-decoration: none"
								onClick="product_show('哥本哈根橡木地板','product-show.jsp','10001')"
								href="javascript:;"><img title="国内品牌" src="images/gq/cn.gif">
							...
							<td class="td-manage"><a style="text-decoration: none"
								...
								onClick="product_edit('产品编辑','product-add.jsp','10001')"
